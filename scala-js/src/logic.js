...
function $s_LHello__main__AT__V(args) {
  $m_LHello$().main__AT__V(args);
}
/** @constructor */
function $c_LHello$() {
}
$c_LHello$.prototype = new $h_O();
$c_LHello$.prototype.constructor = $c_LHello$;
/** @constructor */
function $h_LHello$() {
}
$h_LHello$.prototype = $c_LHello$.prototype;
$c_LHello$.prototype.main__AT__V = (function(args) {
  var parNode = document.createElement("p");
  parNode.textContent = "Esteban";
  document.body.appendChild(parNode);
});
var $d_LHello$ = new $TypeData().initClass($c_LHello$, "Hello$", ({
  LHello$: 1
}));
var $n_LHello$;
function $m_LHello$() {
  if ((!$n_LHello$)) {
    $n_LHello$ = new $c_LHello$();
  }
  return $n_LHello$;
}
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_LHello__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
